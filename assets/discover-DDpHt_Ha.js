import{t as e}from"./book-open-CI1DqGai.js";import{t}from"./chevron-down-xgBk7AoR.js";import{t as n}from"./rotate-ccw-d1sKvlqa.js";import{n as r,t as i}from"./zoom-out-LdhqQePf.js";import{D as a,F as o,I as s,K as c,L as l,P as u,R as d,U as f,c as p,l as m,s as h}from"./index-Drrfgkkf.js";import{t as g}from"./head-seo-DhOoAraB.js";import{t as _}from"./stagger-animation-wI76PPUV.js";var v=o(`hash`,[[`line`,{x1:`4`,x2:`20`,y1:`9`,y2:`9`,key:`4lhtct`}],[`line`,{x1:`4`,x2:`20`,y1:`15`,y2:`15`,key:`vyu0kd`}],[`line`,{x1:`10`,x2:`8`,y1:`3`,y2:`21`,key:`1ggp8o`}],[`line`,{x1:`16`,x2:`14`,y1:`3`,y2:`21`,key:`weycgp`}]]),y=c(f(),1),b=class{gridScale;gridWidth;gridHeight;canvasWidth;canvasHeight;data;stride;sat;satStride;totalOccupied=0;mipScale;mipData=null;mipWidth=0;mipHeight=0;mipStride=0;constructor(e,t,n=3,r=4){this.gridScale=n,this.canvasWidth=e,this.canvasHeight=t,this.mipScale=r,this.gridWidth=Math.ceil(e/n),this.gridHeight=Math.ceil(t/n),this.stride=Math.ceil(this.gridWidth/32),this.data=new Uint32Array(this.stride*this.gridHeight),this.satStride=this.gridWidth+1,this.sat=new Uint32Array(this.satStride*(this.gridHeight+1)),this.gridWidth>=r&&this.gridHeight>=r&&(this.mipWidth=Math.ceil(this.gridWidth/r),this.mipHeight=Math.ceil(this.gridHeight/r),this.mipStride=Math.ceil(this.mipWidth/32),this.mipData=new Uint32Array(this.mipStride*this.mipHeight))}clear(){this.data.fill(0),this.sat.fill(0),this.totalOccupied=0,this.mipData?.fill(0)}toGrid(e,t){return[Math.floor(e/this.gridScale),Math.floor(t/this.gridScale)]}markOccupied(e,t,n,r){let[i,a]=this.toGrid(e-n,t-r),[o,s]=this.toGrid(e+n,t+r),c=Math.max(0,i),l=Math.max(0,a),u=Math.min(this.gridWidth-1,o),d=Math.min(this.gridHeight-1,s);new Uint32Array(this.stride);for(let e=l;e<=d;e++){let t=e*this.stride,n=Math.floor(c/32),r=Math.floor(u/32);if(n===r)this.data[t+n]|=(1<<u-c+1)-1<<(c&31);else{this.data[t+n]|=~((1<<(c&31))-1);for(let e=n+1;e<r;e++)this.data[t+e]=4294967295;this.data[t+r]|=(1<<(u&31)+1)-1}}if(this.rebuildSat(l,d),this.mipData){let e=Math.floor(c/this.mipScale),t=Math.floor(u/this.mipScale),n=Math.floor(l/this.mipScale),r=Math.floor(d/this.mipScale);for(let i=n;i<=r;i++){let n=i*this.mipStride;for(let r=e;r<=t;r++){let e=n+Math.floor(r/32);this.mipData[e]|=1<<(r&31)}}}this.totalOccupied+=(u-c+1)*(d-l+1)}rebuildSat(e,t){let n=Math.max(0,e-1);for(let e=n;e<=t;e++){let t=e*this.stride,n=(e+1)*this.satStride,r=e*this.satStride,i=0;for(let e=0;e<this.gridWidth;e++){let a=this.data[t+Math.floor(e/32)]>>(e&31)&1;i+=a,this.sat[n+e+1]=this.sat[r+e+1]+i}}}satQuery(e,t,n,r){let i=Math.max(0,e),a=Math.max(0,t),o=Math.min(this.gridWidth-1,n),s=Math.min(this.gridHeight-1,r);if(i>o||a>s)return 0;let c=this.sat[a*this.satStride+i],l=this.sat[a*this.satStride+(o+1)],u=this.sat[(s+1)*this.satStride+i];return this.sat[(s+1)*this.satStride+(o+1)]-l-u+c}densityAt(e,t,n){let[r,i]=this.toGrid(e,t),a=Math.ceil(n/this.gridScale),o=r-a,s=i-a,c=r+a,l=i+a,u=this.satQuery(o,s,c,l),d=(Math.min(this.gridWidth-1,c)-Math.max(0,o)+1)*(Math.min(this.gridHeight-1,l)-Math.max(0,s)+1);return d>0?u/d:0}checkCollision(e,t,n,r){let[i,a]=this.toGrid(e-n,t-r),[o,s]=this.toGrid(e+n,t+r);if(i<0||o>=this.gridWidth||a<0||s>=this.gridHeight)return!0;let c=Math.floor(i/32),l=Math.floor(o/32);for(let e=a;e<=s;e++){let t=e*this.stride;if(c===l){let e=(1<<o-i+1)-1<<(i&31);if(this.data[t+c]&e)return!0}else{let e=~((1<<(i&31))-1);if(this.data[t+c]&e)return!0;for(let e=c+1;e<l;e++)if(this.data[t+e])return!0;let n=(1<<(o&31)+1)-1;if(this.data[t+l]&n)return!0}}return!1}mipBlockOccupied(e,t){if(!this.mipData)return!1;let n=Math.floor(e/this.mipScale),r=Math.floor(t/this.mipScale);if(n<0||n>=this.mipWidth||r<0||r>=this.mipHeight)return!0;let i=r*this.mipStride+Math.floor(n/32);return(this.mipData[i]&1<<(n&31))!=0}get freeCells(){return this.gridWidth*this.gridHeight-this.totalOccupied}get totalCells(){return this.gridWidth*this.gridHeight}estimateMaxFreeArea(){if(!this.mipData)return this.freeCells*this.gridScale*this.gridScale;let e=0;for(let t=0;t<this.mipData.length;t++)e+=32-x(this.mipData[t]);return e*this.mipScale*this.mipScale*this.gridScale*this.gridScale}};function x(e){return e-=e>>>1&1431655765,e=(e&858993459)+(e>>>2&858993459),e=e+(e>>>4)&252645135,e*16843009>>>24}function S(e,t,n){switch(n){case`circle`:return Math.sqrt(e*e+t*t)-1;case`heart`:{let n=e*1.2,r=(t+.22)*1.1,i=n*n+r*r-1,a=i*i*i-n*n*r*r*r;if(a<=.04)return-Math.max(0,.05-a*.5);let o=Math.sqrt(n*n+r*r)-.9;return Math.max(0,o)}case`star`:{let n=Math.sqrt(e*e+t*t);if(n<.001)return-1;let r=(Math.atan2(t,e)%(2*Math.PI/5)+2*Math.PI/5)%(2*Math.PI/5),i=Math.PI/5;return n-(r<i?.42+r/i*.58:1-.58*((r-i)/i))}case`diamond`:return Math.abs(e)+Math.abs(t)-1;case`cloud`:{let n=[[0,0,.48],[-.38,.12,.4],[.38,.12,.4],[-.22,-.28,.44],[.22,-.28,.44],[0,.32,.34]],r=1/0;for(let[i,a,o]of n){let n=Math.sqrt((e-i)**2+(t-a)**2)-o;n<r&&(r=n)}return r}case`hexagon`:{let n=Math.sqrt(e*e+t*t);if(n<.001)return-1;let r=(Math.atan2(t,e)%(Math.PI/3)+Math.PI/3)%(Math.PI/3);return n-Math.cos(Math.PI/6)/Math.cos(r-Math.PI/6)}}}function C(e,t,n){switch(n){case`circle`:return e*e+t*t<=1;case`heart`:{let n=e*1.2,r=(t+.22)*1.1,i=n*n+r*r-1;return i*i*i-n*n*r*r*r<=.04}case`star`:{let n=Math.sqrt(e*e+t*t);if(n<.001)return!0;let r=(Math.atan2(t,e)%(2*Math.PI/5)+2*Math.PI/5)%(2*Math.PI/5),i=Math.PI/5;return n<=(r<i?.42+r/i*.58:1-.58*((r-i)/i))}case`diamond`:return Math.abs(e)+Math.abs(t)<=1;case`cloud`:for(let[n,r,i]of[[0,0,.48],[-.38,.12,.4],[.38,.12,.4],[-.22,-.28,.44],[.22,-.28,.44],[0,.32,.34]])if((e-n)**2+(t-r)**2<=i*i)return!0;return!1;case`hexagon`:{let n=Math.sqrt(e*e+t*t);if(n<.001)return!0;let r=(Math.atan2(t,e)%(Math.PI/3)+Math.PI/3)%(Math.PI/3);return n<=Math.cos(Math.PI/6)/Math.cos(r-Math.PI/6)}}}function w(e,t,n){return S(e,t,n)}function T(e,t,n){let r=S(e,t,n),i=Math.max(.001,Math.abs(r)*.01),a=S(e+i,t,n)-r,o=S(e,t+i,n)-r,s=Math.sqrt(a*a+o*o);if(s<1e-8){let n=Math.sqrt(e*e+t*t)||1;return[-e/n,-t/n]}return[a/s,o/s]}function E(e,t,n,r,i,a,o,s){let c=(e-i)/o,l=(t-a)/o,u=n/o,d=r/o;if(s===`circle`){let e=S(c,l,s),t=Math.sqrt(u*u+d*d);if(e>t)return{fits:!1,zone:`outside`};if(e<-t)return{fits:!0,zone:`deep`};let i=n*2*(r*2)>800?[[c,l],[c,l-d],[c,l+d],[c-u,l],[c+u,l],[c-u,l-d],[c+u,l-d],[c-u,l+d],[c+u,l+d]]:[[c,l],[c-u,l-d],[c+u,l-d],[c-u,l+d],[c+u,l+d]];for(let[e,t]of i)if(!C(e,t,s))return{fits:!1,zone:`edge`};return{fits:!0,zone:`edge`}}let f=[[c,l],[c-u,l-d],[c+u,l-d],[c-u,l+d],[c+u,l+d]],p=0;for(let[e,t]of f)C(e,t,s)&&p++;return p>=3?{fits:!0,zone:p>=5?`deep`:`edge`}:{fits:!1,zone:`edge`}}function D(e,t,n,r,i,a,o,s,c=5){let l=e,u=t;for(let e=0;e<c;e++){let e=(l-i)/o,t=(u-a)/o,c=S(e,t,s);if(c<=0){if(E(l,u,n,r,i,a,o,s).fits)return[l,u];let[c,d]=T(e,t,s);l-=c*n*.3,u-=d*r*.3;continue}let[d,f]=T(e,t,s),p=Math.abs(c)*o;l-=d*p,u-=f*p}return[l,u]}function O(e,t,n,r,i,a,o,s,c,l,u){let d=S((e-n)/i,(t-r)/i,a);if(d<-.3)return c;let f=Math.max(l,u)/i;if(d>f)return s;let p=(d+f)/(2*f),m=o-Math.max(0,Math.min(1,p))*(o-s);return Math.max(s,Math.min(c,m))}function k(e,t){if(e===`circle`)return[[0,0]];let n=[];for(let t=0;t<60;t++)for(let r=0;r<60;r++){let i=t/59*2-1,a=r/59*2-1,o=S(i,a,e);o<-.03&&n.push({x:i,y:a,sdf:o})}n.sort((e,t)=>e.sdf-t.sdf);let r=[];for(let e of n){if(r.length>=t)break;let n=!1;for(let[t,i]of r)if((e.x-t)**2+(e.y-i)**2<.03){n=!0;break}n||r.push([e.x,e.y])}return r}function*A(e,t,n=.06){if(e===`circle`){let e=1+t;if(e<=0)return;let r=Math.ceil(2*Math.PI/n);for(let t=0;t<r;t++){let n=t/r*2*Math.PI;yield[e*Math.cos(n),e*Math.sin(n)]}return}let r=Math.ceil(2*Math.PI/n),i=n*.4;for(let n=0;n<r;n++){let a=n/r*2*Math.PI+(Math.random()-.5)*i,o=.35+Math.abs(t)*.6,s=o*Math.cos(a),c=o*Math.sin(a);for(let n=0;n<20;n++){let n=S(s,c,e)-t;if(Math.abs(n)<5e-4)break;let[r,i]=T(s,c,e),a=r*r+i*i;if(a<1e-10)break;let o=n/a;s-=r*o,c-=i*o;let l=Math.sqrt(s*s+c*c);l>1.5&&(s*=1.5/l,c*=1.5/l)}S(s,c,e)<.02&&(yield[s,c])}}function j(e,t,n){let r=Math.max(e,t)/n;return r>.15?.12:r>.08?.08:.05}var M={circle:{icon:`●`,label:`圆形`},heart:{icon:`♥`,label:`心形`},star:{icon:`★`,label:`星形`},diamond:{icon:`◆`,label:`菱形`},cloud:{icon:`☁`,label:`云形`},hexagon:{icon:`⬡`,label:`六边形`}},ee=[`circle`,`heart`,`star`,`diamond`,`cloud`,`hexagon`],N={width:800,height:600,shape:`circle`,minFontSize:11,maxFontSize:42,padding:3,gridScale:3,rotationSteps:0,fontFamily:`sans-serif`,fontWeight:`bold`},P=.12,F=.4,te=2e4,I=[1,.75,.5625,.421875],L=/[\u4e00-\u9fff\u3040-\u309f\u30a0-\u30ff\uac00-\ud7af]/;function R(e){let t=0;for(let n of e)L.test(n)&&t++;return t>e.length*.5}function z(e,t,n,r){return t<=0?n:n+(r-n)*Math.sqrt(e/t)}function B(e,t,n,r,i,a,o,s,c,l){let u=Math.random()*Math.PI*2,d=0,f=null,p=Math.sqrt(t*t+n*n)*.5,m=e.gridScale;for(let h=0;h<te;h++){let h=r+d*Math.cos(u),g=i+d*Math.sin(u);if(h-t<0||h+t>=s||g-n<0||g+n>=c){u+=P,d+=F*P;continue}let _=w((h-r)/a,(g-i)/a,o);if(_>.15){d+=Math.abs(_)*a*.8+p,u+=P;continue}if(e.mipBlockOccupied(Math.floor(h/m),Math.floor(g/m))){d+=2*F*P,u+=P;continue}let[v,y]=[h,g];if(!E(v,y,t,n,r,i,a,o).fits){let[e,s]=D(v,y,t,n,r,i,a,o,4);if(!E(e,s,t,n,r,i,a,o).fits){u+=P,d+=F*P;continue}v=e,y=s}if(!e.checkCollision(v,y,t,n)){let r=e.densityAt(v,y,Math.max(t,n)*1.5);if((f===null||r<f.score)&&(f={x:v,y,score:r,rotated:!1},r<.08))break}if(l){let[l,u]=[n,t];if(v-l>=0&&v+l<s&&y-u>=0&&y+u<c&&E(v,y,l,u,r,i,a,o).fits&&!e.checkCollision(v,y,l,u)){let t=e.densityAt(v,y,Math.max(l,u)*1.5);if((f===null||t<f.score)&&(f={x:v,y,score:t,rotated:!0},t<.08))break}}u+=P,d+=F*P}return f}function V(e,t,n,r,i,a,o,s,c,l){let u=e.gridScale,d=j(t,n,a),f=[-.02,-.06,-.12,-.2,-.3,-.42,-.55],p=null;for(let m of f){for(let[f,h]of A(o,m,d)){let d=r+f*a,m=i+h*a;if(d-t<0||d+t>=s||m-n<0||m+n>=c||e.mipBlockOccupied(Math.floor(d/u),Math.floor(m/u)))continue;let[g,_]=[d,m];if(!E(g,_,t,n,r,i,a,o).fits){let[e,s]=D(g,_,t,n,r,i,a,o,3);if(!E(e,s,t,n,r,i,a,o).fits)continue;g=e,_=s}if(!e.checkCollision(g,_,t,n)){let r=e.densityAt(g,_,Math.max(t,n)*1.5);if((p===null||r<p.score)&&(p={x:g,y:_,score:r,rotated:!1},r<.05))return p}if(l){let[l,u]=[n,t];if(g-l>=0&&g+l<s&&_-u>=0&&_+u<c&&E(g,_,l,u,r,i,a,o).fits&&!e.checkCollision(g,_,l,u)){let t=e.densityAt(g,_,Math.max(l,u)*1.5);if((p===null||t<p.score)&&(p={x:g,y:_,score:t,rotated:!0},t<.05))return p}}}if(p)return p}return B(e,t,n,r,i,a,o,s,c,l)}function H(e,t,n,r,i,a,o,s,c,l,u,d){let f=a+t*s,p=o+n*s;return f-r<0||f+r>=l||p-i<0||p+i>=u||!E(f,p,r,i,a,o,s,c).fits||e.checkCollision(f,p,r,i)?null:{x:f,y:p,rotated:!1}}function U(e,t,n,r,i,a,o,s,c,l){return o===`circle`?B(e,t,n,r,i,a,o,s,c,l):V(e,t,n,r,i,a,o,s,c,l)}function W(e,t){let n=t.estimateMaxFreeArea();return e<=n*.3?0:e<=n*.8?1:e<=n*1.5?2:3}function G(e,t={}){let n={...N,...t};if(e.length===0)return{words:[],placedCount:0,totalCount:0,fillRate:0};let{width:r,height:i,shape:a,minFontSize:o,maxFontSize:s,padding:c,gridScale:l,rotationSteps:u,fontFamily:d,fontWeight:f}=n,p=[...e].sort((e,t)=>t.weight-e.weight),m=Math.max(...p.map(e=>e.weight),1),h=r/2,g=i/2,_=Math.min(r,i)/2*.85,v=new b(r,i,l),y=null,x=()=>(y||=document.createElement(`canvas`).getContext(`2d`),y),S=[],C=u>=1,w=[],T=0;a!==`circle`&&(w=k(a,Math.max(3,Math.min(12,Math.ceil(p.length*.12)))));for(let e=0;e<p.length;e++){let t=p[e],n=z(t.weight,m,o,s),l,u;if(t.width!==void 0&&t.height!==void 0)l=t.width+c*2,u=t.height+c*2;else{let e=x();if(!e)break;e.font=`${f} ${n}px ${d}`,l=e.measureText(t.text).width+c*2,u=(R(t.text)?n:n*1.2)+c*2}let y=W(l*u,v),b=null;if(a!==`circle`&&T<w.length&&e<Math.ceil(p.length*.15)){for(let e=y;e<4;e++){if(e>y){let r=I[e];n=Math.max(o,z(t.weight,m,o,s)*r);let i=x();if(!i)break;i.font=`${f} ${n}px ${d}`,l=i.measureText(t.text).width+c*2,u=(R(t.text)?n:n*1.2)+c*2}let p=l/2,S=u/2,[E,D]=w[T],k=[[0,0],[.08,0],[-.08,0],[0,.08],[0,-.08]],A=!1;for(let[e,t]of k){let c=H(v,E+e,D+t,p,S,h,g,_,a,r,i,C);if(c){let e=O(c.x,c.y,h,g,_,a,s,o,n,p,S);b={x:c.x,y:c.y,fs:e,rotated:c.rotated},A=!0;break}}if(A)break}T++}if(!b)for(let e=y;e<4;e++){if(e>y){let r=I[e];n=Math.max(o,z(t.weight,m,o,s)*r);let i=x();if(!i)break;i.font=`${f} ${n}px ${d}`,l=i.measureText(t.text).width+c*2,u=(R(t.text)?n:n*1.2)+c*2}let p=l/2,S=u/2,w=U(v,p,S,h,g,_,a,r,i,C);if(w){let e=O(w.x,w.y,h,g,_,a,s,o,n,p,S);b={x:w.x,y:w.y,fs:e,rotated:w.rotated};break}}if(!b)continue;let E={id:t.id,text:t.text,x:b.x,y:b.y,fontSize:b.fs,width:l,height:u,rotated:b.rotated};S.push(E),v.markOccupied(b.x,b.y,b.rotated?u/2:l/2,b.rotated?l/2:u/2)}let E=0;for(let e of S)E+=e.width*e.height;let D=r*i>0?E/(r*i):0;return{words:S,placedCount:S.length,totalCount:e.length,fillRate:D}}var K=8,q=3e4;function ne(e,t={},n={}){let{timeout:r=q}=n,i=ie();return new Promise((n,a)=>{let o=new Blob([i],{type:`application/javascript`}),s=URL.createObjectURL(o),c=new Worker(s,{type:`classic`}),l=setTimeout(()=>{c.terminate(),URL.revokeObjectURL(s),a(Error(`WordCloud worker timed out`))},r);c.onmessage=e=>{if(clearTimeout(l),c.terminate(),URL.revokeObjectURL(s),e.data.type===`SUCCESS`){let{buffer:t,texts:r,placedCount:i,totalCount:a,fillRate:o}=e.data;n({words:re(t,r),placedCount:i,totalCount:a,fillRate:o})}else e.data.type===`ERROR`?a(Error(e.data.error)):a(Error(`Unknown worker response`))},c.onerror=e=>{clearTimeout(l),c.terminate(),URL.revokeObjectURL(s),a(Error(e.message))},c.postMessage({type:`compute`,words:e,config:t})})}function re(e,t){let n=e.length/K,r=[];for(let i=0;i<n;i++){let n=i*K,a=e[n+7];r.push({id:e[n],x:e[n+1],y:e[n+2],fontSize:e[n+3],width:e[n+4],height:e[n+5],rotated:e[n+6]!==0,text:t[a]||``})}return r}function ie(){return`
/* ================================================================== */
...
/* ================================================================== */
/*  Inlined: shapes.ts v4 — analytic SDF, adaptive, push-to-edge      */
/*  v4: + skeletonAnchors, walkIsocontour, isocontourAngleStep         */
/* ================================================================== */
...
function analyticSdf(nx, ny, shape) {
  switch (shape) {
    ...
    case "heart": {
      var hx = nx * 1.2, hy = (ny + 0.22) * 1.1, v = hx * hx + hy * hy - 1
      var expr = v * v * v - hx * hx * hy * hy * hy
      if (expr <= 0.04) return -Math.max(0, 0.05 - expr * 0.5)
      var d = Math.sqrt(hx * hx + hy * hy) - 0.9
      return Math.max(0, d)
    }
    case "star": {
      var d = Math.sqrt(nx * nx + ny * ny)
...
function wordFitsInShapeAdaptive(cx, cy, halfW, halfH, shapeCenterX, shapeCenterY, shapeRadius, shape) {
  ...
  // Non-circle: use permissive 3/5 check
  ...
  if (inside >= 3) return { fits: true, zone: inside >= 5 ? "deep" : "edge" }
...
function computeSkeletonAnchors(shape, count) {
  ...
  for (var i = 0; i < gridRes; i++) {
    for (var j = 0; j < gridRes; j++) {
      ...
      var sdf = analyticSdf(nx, ny, shape)
      if (sdf < -0.03) candidates.push({ x: nx, y: ny, sdf: sdf })
    }
  }
...
function walkIsocontour(shape, targetSdf, angleStep) {
  ...
  return {
    next: function() {
      while (idx < count) {
        var angle = (idx / count) * 2 * Math.PI + (Math.random() - 0.5) * jitter
        ...
        idx++
        if (shape === "circle" || analyticSdf(nx, ny, shape) < 0.02) return { value: [nx, ny], done: false }
      }
      return { done: true }
    },
...
function isocontourAngleStep(halfW, halfH, shapeRadius) {
...
function findPlacementIsocontour(grid, halfW, halfH, shapeCenterX, shapeCenterY, shapeRadius, shape, canvasW, canvasH, allowRotation) {
  var gridScale = grid.gridScale
  var angleStep = isocontourAngleStep(halfW, halfH, shapeRadius)
  var isoLevels = [-0.02, -0.06, -0.12, -0.20, -0.30, -0.42, -0.55]
  var bestCandidate = null
  for (var li = 0; li < isoLevels.length; li++) {
    ...
    while (!iterResult.done) {
      ...
      if (!grid.checkCollision(sx, sy, halfW, halfH)) {
        ...
        if (!bestCandidate || density < bestCandidate.score) {
          bestCandidate = { x: sx, y: sy, score: density, rotated: false }
          if (density < 0.05) return bestCandidate
        }
      }
      if (allowRotation) {
        var rw = halfH, rh = halfW
        if (sx - rw >= 0 && sx + rw < canvasW && sy - rh >= 0 && sy + rh < canvasH &&
          ...
          if (!bestCandidate || rd < bestCandidate.score) {
            bestCandidate = { x: sx, y: sy, score: rd, rotated: true }
            if (rd < 0.05) return bestCandidate
          }
        }
      }
...
function findPlacement(grid, halfW, halfH, shapeCenterX, shapeCenterY, shapeRadius, shape, canvasW, canvasH, allowRotation) {
  ...
  return findPlacementIsocontour(grid, halfW, halfH, shapeCenterX, shapeCenterY, shapeRadius, shape, canvasW, canvasH, allowRotation)
}
...
function computeLayout(words, config) {
  ...
  if (shape !== "circle") {
    var anchorCount = Math.max(3, Math.min(12, Math.ceil(sorted.length * 0.12)))
  ...
  for (var i = 0; i < sorted.length; i++) {
    ...
    // Phase 2: Normal placement (isocontour or spiral)
    if (!bestResult) {
      for (var level = startLevel; level < 4; level++) {
        if (level > startLevel) {
          fontSize = Math.max(minFontSize, mapFontSize(word.weight, maxWeight, minFontSize, maxFontSize) * SIZE_RATIOS[level])
        ...
        if (placement) {
          var cappedFs = edgeCappedFontSize(placement.x, placement.y, shapeCenterX, shapeCenterY, shapeRadius, shape, maxFontSize, minFontSize, fontSize, w/2, h/2)
