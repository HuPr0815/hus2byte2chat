import{t as e}from"./book-open-VIfWvwpr.js";import{t}from"./chevron-down-CULKxXXg.js";import{t as n}from"./rotate-ccw-Cvm4NAxd.js";import{n as r,t as i}from"./zoom-out-BfrIHJsz.js";import{B as a,H as o,R as s,V as c,X as l,d as u,f as d,j as f,q as p,u as m,z as h}from"./index-CPu7Oc67.js";import{t as g}from"./head-seo-BvG4qXdO.js";import{t as _}from"./stagger-animation-D3X24Jfg.js";var v=h(`hash`,[[`line`,{x1:`4`,x2:`20`,y1:`9`,y2:`9`,key:`4lhtct`}],[`line`,{x1:`4`,x2:`20`,y1:`15`,y2:`15`,key:`vyu0kd`}],[`line`,{x1:`10`,x2:`8`,y1:`3`,y2:`21`,key:`1ggp8o`}],[`line`,{x1:`16`,x2:`14`,y1:`3`,y2:`21`,key:`weycgp`}]]),y=l(p(),1),b=class{gridScale;gridWidth;gridHeight;canvasWidth;canvasHeight;data;stride;sat;satStride;totalOccupied=0;mipScale;mipData=null;mipWidth=0;mipHeight=0;mipStride=0;constructor(e,t,n=3,r=4){this.gridScale=n,this.canvasWidth=e,this.canvasHeight=t,this.mipScale=r,this.gridWidth=Math.ceil(e/n),this.gridHeight=Math.ceil(t/n),this.stride=Math.ceil(this.gridWidth/32),this.data=new Uint32Array(this.stride*this.gridHeight),this.satStride=this.gridWidth+1,this.sat=new Uint32Array(this.satStride*(this.gridHeight+1)),this.gridWidth>=r&&this.gridHeight>=r&&(this.mipWidth=Math.ceil(this.gridWidth/r),this.mipHeight=Math.ceil(this.gridHeight/r),this.mipStride=Math.ceil(this.mipWidth/32),this.mipData=new Uint32Array(this.mipStride*this.mipHeight))}clear(){this.data.fill(0),this.sat.fill(0),this.totalOccupied=0,this.mipData?.fill(0)}toGrid(e,t){return[Math.floor(e/this.gridScale),Math.floor(t/this.gridScale)]}markOccupied(e,t,n,r){let[i,a]=this.toGrid(e-n,t-r),[o,s]=this.toGrid(e+n,t+r),c=Math.max(0,i),l=Math.max(0,a),u=Math.min(this.gridWidth-1,o),d=Math.min(this.gridHeight-1,s);new Uint32Array(this.stride);for(let e=l;e<=d;e++){let t=e*this.stride,n=Math.floor(c/32),r=Math.floor(u/32);if(n===r)this.data[t+n]|=(1<<u-c+1)-1<<(c&31);else{this.data[t+n]|=~((1<<(c&31))-1);for(let e=n+1;e<r;e++)this.data[t+e]=4294967295;this.data[t+r]|=(1<<(u&31)+1)-1}}if(this.rebuildSat(l,d),this.mipData){let e=Math.floor(c/this.mipScale),t=Math.floor(u/this.mipScale),n=Math.floor(l/this.mipScale),r=Math.floor(d/this.mipScale);for(let i=n;i<=r;i++){let n=i*this.mipStride;for(let r=e;r<=t;r++){let e=n+Math.floor(r/32);this.mipData[e]|=1<<(r&31)}}}this.totalOccupied+=(u-c+1)*(d-l+1)}rebuildSat(e,t){let n=Math.max(0,e-1);for(let e=n;e<=t;e++){let t=e*this.stride,n=(e+1)*this.satStride,r=e*this.satStride,i=0;for(let e=0;e<this.gridWidth;e++){let a=this.data[t+Math.floor(e/32)]>>(e&31)&1;i+=a,this.sat[n+e+1]=this.sat[r+e+1]+i}}}satQuery(e,t,n,r){let i=Math.max(0,e),a=Math.max(0,t),o=Math.min(this.gridWidth-1,n),s=Math.min(this.gridHeight-1,r);if(i>o||a>s)return 0;let c=this.sat[a*this.satStride+i],l=this.sat[a*this.satStride+(o+1)],u=this.sat[(s+1)*this.satStride+i];return this.sat[(s+1)*this.satStride+(o+1)]-l-u+c}densityAt(e,t,n){let[r,i]=this.toGrid(e,t),a=Math.ceil(n/this.gridScale),o=r-a,s=i-a,c=r+a,l=i+a,u=this.satQuery(o,s,c,l),d=(Math.min(this.gridWidth-1,c)-Math.max(0,o)+1)*(Math.min(this.gridHeight-1,l)-Math.max(0,s)+1);return d>0?u/d:0}checkCollision(e,t,n,r){let[i,a]=this.toGrid(e-n,t-r),[o,s]=this.toGrid(e+n,t+r);if(i<0||o>=this.gridWidth||a<0||s>=this.gridHeight)return!0;let c=Math.floor(i/32),l=Math.floor(o/32);for(let e=a;e<=s;e++){let t=e*this.stride;if(c===l){let e=(1<<o-i+1)-1<<(i&31);if(this.data[t+c]&e)return!0}else{let e=~((1<<(i&31))-1);if(this.data[t+c]&e)return!0;for(let e=c+1;e<l;e++)if(this.data[t+e])return!0;let n=(1<<(o&31)+1)-1;if(this.data[t+l]&n)return!0}}return!1}mipBlockOccupied(e,t){if(!this.mipData)return!1;let n=Math.floor(e/this.mipScale),r=Math.floor(t/this.mipScale);if(n<0||n>=this.mipWidth||r<0||r>=this.mipHeight)return!0;let i=r*this.mipStride+Math.floor(n/32);return(this.mipData[i]&1<<(n&31))!=0}get freeCells(){return this.gridWidth*this.gridHeight-this.totalOccupied}get totalCells(){return this.gridWidth*this.gridHeight}estimateMaxFreeArea(){if(!this.mipData)return this.freeCells*this.gridScale*this.gridScale;let e=0;for(let t=0;t<this.mipData.length;t++)e+=32-x(this.mipData[t]);return e*this.mipScale*this.mipScale*this.gridScale*this.gridScale}};function x(e){return e-=e>>>1&1431655765,e=(e&858993459)+(e>>>2&858993459),e=e+(e>>>4)&252645135,e*16843009>>>24}function S(e,t,n){switch(n){case`circle`:return Math.sqrt(e*e+t*t)-1;case`heart`:{let n=e*1.2,r=-t*1.1,i=n*n+r*r-1,a=i*i*i-n*n*r*r*r,o=i*i,s=6*n*o-2*n*r*r*r,c=6*r*o-3*n*n*r*r,l=Math.sqrt(s*s+c*c);return l<1e-8?Math.sqrt(n*n+r*r)-.9:a/(l*1.15)}case`star`:{let n=Math.sqrt(e*e+t*t);if(n<.001)return-1;let r=Math.atan2(t,e),i=Math.PI*2/5,a=(r%i+i)%i,o=Math.PI/5;return n-(a<o?.42+a/o*.58:1-.58*((a-o)/o))}case`diamond`:return Math.abs(e)+Math.abs(t)-1;case`cloud`:{let n=[[0,0,.48],[-.38,.12,.4],[.38,.12,.4],[-.22,-.28,.44],[.22,-.28,.44],[0,.32,.34]],r=1/0;for(let[i,a,o]of n){let n=Math.sqrt((e-i)**2+(t-a)**2)-o;n<r&&(r=n)}return r}case`hexagon`:{let n=Math.sqrt(e*e+t*t);if(n<.001)return-1;let r=(Math.atan2(t,e)%(Math.PI/3)+Math.PI/3)%(Math.PI/3);return n-Math.cos(Math.PI/6)/Math.cos(r-Math.PI/6)}}}function C(e,t,n){switch(n){case`circle`:return e*e+t*t<=1;case`heart`:{let n=e*1.2,r=-t*1.1,i=n*n+r*r-1;return i*i*i-n*n*r*r*r<=.04}case`star`:{let n=Math.sqrt(e*e+t*t);if(n<.001)return!0;let r=Math.atan2(t,e),i=Math.PI*2/5,a=(r%i+i)%i,o=Math.PI/5;return n<=(a<o?.42+a/o*.58:1-.58*((a-o)/o))}case`diamond`:return Math.abs(e)+Math.abs(t)<=1;case`cloud`:for(let[n,r,i]of[[0,0,.48],[-.38,.12,.4],[.38,.12,.4],[-.22,-.28,.44],[.22,-.28,.44],[0,.32,.34]])if((e-n)**2+(t-r)**2<=i*i)return!0;return!1;case`hexagon`:{let n=Math.sqrt(e*e+t*t);if(n<.001)return!0;let r=(Math.atan2(t,e)%(Math.PI/3)+Math.PI/3)%(Math.PI/3);return n<=Math.cos(Math.PI/6)/Math.cos(r-Math.PI/6)}}}function w(e,t,n){return C(e,t,n)}function T(e,t,n){return S(e,t,n)}function E(e,t){let n=e*1.2,r=-t*1.1,i=n*n+r*r-1,a=i*i,o=6*n*a-2*n*r*r*r,s=6*r*a-3*n*n*r*r;if(Math.sqrt(o*o+s*s)<1e-8){let e=Math.sqrt(n*n+r*r)||1;return[-n/e,-r/e]}let c=o*1.2,l=-s*1.1,u=Math.sqrt(c*c+l*l);return[c/u,l/u]}function D(e,t){let n=Math.sqrt(e*e+t*t);if(n<.001)return[-1,0];let r=Math.atan2(t,e),i=Math.PI*2/5,a=(r%i+i)%i,o=Math.PI/5,s=a<o?.58/o:-.58/o,c=e/n-s*(-t/(n*n)),l=t/n-s*(e/(n*n)),u=Math.sqrt(c*c+l*l);return u<1e-8?[-e/n,-t/n]:[c/u,l/u]}function O(e,t,n){if(n===`heart`)return E(e,t);if(n===`star`)return D(e,t);let r=S(e,t,n),i=Math.max(.001,Math.abs(r)*.01),a=S(e+i,t,n)-r,o=S(e,t+i,n)-r,s=Math.sqrt(a*a+o*o);if(s<1e-8){let n=Math.sqrt(e*e+t*t)||1;return[-e/n,-t/n]}return[a/s,o/s]}function k(e,t,n){if(n!==`heart`)return 0;let r=.005,i=S(e,t,n),a=S(e+r,t,n),o=S(e-r,t,n),s=S(e,t+r,n),c=S(e,t-r,n),l=(a-2*i+o)/(r*r),u=(s-2*i+c)/(r*r);return Math.abs(l)+Math.abs(u)}function A(e,t,n){if(n!==`heart`)return 1;let r=k(e,t,n),i=S(e,t,n);return r>80&&i>-.15?.65:r>50&&i>-.1?.75:r>30&&i>-.05?.85:1}function j(e,t,n){let[r,i]=O(e,t,n);return Math.atan2(-i,r)}function M(e,t,n,r,i,a,o,s){let c=(e-i)/o,l=(t-a)/o,u=n/o,d=r/o;if(s===`circle`){let e=S(c,l,s),t=Math.sqrt(u*u+d*d);if(e>t)return{fits:!1,zone:`outside`};if(e<-t)return{fits:!0,zone:`deep`};let n=[[c,l],[c-u,l-d],[c+u,l-d],[c-u,l+d],[c+u,l+d]];for(let[e,t]of n)if(!C(e,t,s))return{fits:!1,zone:`edge`};return{fits:!0,zone:`edge`}}let f=s===`heart`?4:3,p=[[c,l],[c-u,l-d],[c+u,l-d],[c-u,l+d],[c+u,l+d]],m=0;for(let[e,t]of p)C(e,t,s)&&m++;return m>=f?{fits:!0,zone:m>=5?`deep`:`edge`}:{fits:!1,zone:`edge`}}function N(e,t,n,r,i,a,o,s,c=5){let l=e,u=t;for(let e=0;e<c;e++){let e=(l-i)/o,t=(u-a)/o,c=S(e,t,s);if(c<=0){if(M(l,u,n,r,i,a,o,s).fits)return[l,u];let[c,d]=O(e,t,s);l-=c*n*.3,u-=d*r*.3;continue}let[d,f]=O(e,t,s),p=Math.abs(c)*o;l-=d*p,u-=f*p}return[l,u]}function P(e,t,n,r,i,a,o,s,c,l,u){let d=S((e-n)/i,(t-r)/i,a);if(d<-.3)return c;let f=Math.max(l,u)/i;if(d>f)return s;if(a===`heart`){let e=(d+f*.3)/(f*1.3);return Math.max(s,Math.min(c,o-Math.max(0,Math.min(1,e))*(o-s)*.5))}let p=(d+f)/(2*f);return Math.max(s,Math.min(c,o-Math.max(0,Math.min(1,p))*(o-s)))}function ee(e){switch(e){case`heart`:return[[-.35,-.28],[.35,-.28],[0,.55],[-.18,-.08],[.18,-.08],[0,-.12],[-.5,.15],[.5,.15]];case`star`:{let e=[];for(let t=0;t<5;t++){let n=t/5*Math.PI*2-Math.PI/2,r=n+Math.PI/5;e.push([Math.cos(n)*.85,Math.sin(n)*.85]),e.push([Math.cos(r)*.35,Math.sin(r)*.35]);let i=n+Math.PI/10;e.push([Math.cos(i)*.55,Math.sin(i)*.55])}return e.push([0,0]),e}case`diamond`:return[[0,-.85],[0,.85],[-.85,0],[.85,0],[-.4,-.4],[.4,-.4],[-.4,.4],[.4,.4]];case`cloud`:return[[0,-.35],[-.38,-.12],[.38,-.12],[-.22,.28],[.22,.28],[0,.05]];case`hexagon`:{let e=[];for(let t=0;t<6;t++){let n=t/6*Math.PI*2-Math.PI/6;e.push([Math.cos(n)*.85,Math.sin(n)*.85])}return e.push([0,0]),e}case`circle`:return[[0,0]]}}function te(e,t){if(e===`circle`)return[[0,0]];let n=ee(e),r=[];for(let i of n){if(r.length>=t)break;C(i[0],i[1],e)&&r.push([i[0],i[1]])}if(r.length<t){let n=[];for(let t=0;t<60;t++)for(let r=0;r<60;r++){let i=t/59*2-1,a=r/59*2-1;C(i,a,e)&&n.push({x:i,y:a,sdf:S(i,a,e)})}n.sort((e,t)=>e.sdf-t.sdf);for(let e of n){if(r.length>=t)break;let n=!1;for(let[t,i]of r)if((e.x-t)**2+(e.y-i)**2<.03){n=!0;break}n||r.push([e.x,e.y])}}return r}function*F(e,t,n=.06,r=.02){if(e===`circle`){let e=1+t;if(e<=0)return;let r=Math.ceil(2*Math.PI/n),i=Array.from({length:r},(e,t)=>t);for(let e=i.length-1;e>0;e--){let t=Math.floor(Math.random()*(e+1));[i[e],i[t]]=[i[t],i[e]]}for(let t of i){let n=t/r*2*Math.PI;yield[e*Math.cos(n),e*Math.sin(n)]}return}let i=Math.ceil(2*Math.PI/n),a=n*.4,o=[];for(let n=0;n<i;n++){let s=n/i*2*Math.PI+(Math.random()-.5)*a,c=.35+Math.abs(t)*.6,l=c*Math.cos(s),u=c*Math.sin(s),d=!1;for(let n=0;n<15;n++){let n=S(l,u,e)-t;if(Math.abs(n)<.001){d=!0;break}let[r,i]=O(l,u,e),a=r*r+i*i;if(a<1e-10)break;let o=n/a;l-=r*o,u-=i*o;let s=Math.sqrt(l*l+u*u);s>1.5&&(l*=1.5/s,u*=1.5/s)}if(d&&e===`heart`){let[t,n]=O(l,u,e);if(t*t+n*n<r*r)continue}S(l,u,e)<.02&&o.push([l,u])}if(o.length<10&&n>.02){yield*F(e,t,n*.5,r);return}for(let e=o.length-1;e>0;e--){let t=Math.floor(Math.random()*(e+1));[o[e],o[t]]=[o[t],o[e]]}for(let e of o)yield e}function I(e,t,n,r,i){let a=Math.max(e,t)/n;return r===`heart`&&i!==void 0?i>-.06?a>.1?.06:.03:i>-.2?a>.1?.08:.04:a>.15?.12:.06:r===`star`||r===`cloud`?a>.15?.14:a>.08?.1:.06:a>.15?.12:a>.08?.08:.05}function L(e,t,n,r){let i=S(e,t,n);return Math.abs(i)*r*.7}function ne(e,t,n,r,i,a){let o=L(e,t,i,a);return n>o||r>o}var re={circle:{icon:`●`,label:`圆形`},heart:{icon:`♥`,label:`心形`},star:{icon:`★`,label:`星形`},diamond:{icon:`◆`,label:`菱形`},cloud:{icon:`☁`,label:`云形`},hexagon:{icon:`⬡`,label:`六边形`}},ie=[`circle`,`heart`,`star`,`diamond`,`cloud`,`hexagon`],ae={width:800,height:600,shape:`circle`,minFontSize:11,maxFontSize:42,padding:3,gridScale:3,rotationSteps:0,fontFamily:`sans-serif`,fontWeight:`bold`},R=.12,z=.4,B=2e4,V=[1,.75,.5625,.421875],H=/[\u4e00-\u9fff\u3040-\u309f\u30a0-\u30ff\uac00-\ud7af]/;function U(e){let t=0;for(let n of e)H.test(n)&&t++;return t>e.length*.5}function W(e,t,n,r){return t<=0?n:n+(r-n)*Math.sqrt(e/t)}function oe(e,t,n=64){let r=0;for(let t=0;t<n;t++)for(let i=0;i<n;i++)w(t/(n-1)*2-1,i/(n-1)*2-1,e)&&r++;return 2*t*(2*t)*(r/(n*n))}function se(e,t,n,r,i,a,o,s,c,l){let u=n*(c===`circle`?.65:.5),d=0;for(let n of e){let e=W(n.weight,t,r,i);l.font=`${s} ${e}px ${o}`;let c=l.measureText(n.text).width+a*2,u=(U(n.text)?e:e*1.2)+a*2;d+=c*u}if(d<=u)return 1;let f=Math.sqrt(u/d);return Math.max(.3,f)}function G(e,t){return te(e,8).map(([n,r])=>{let i=T(n,r,e);return{nx:n,ny:r,clearance:Math.abs(i)*t*2,used:!1}}).sort((e,t)=>t.clearance-e.clearance)}function K(e){switch(e){case`heart`:return[[-.25,-.15],[.25,-.15],[0,.25]];case`star`:{let e=[[0,0]];for(let t=0;t<5;t++){let n=t/5*Math.PI*2-Math.PI/2;e.push([Math.cos(n)*.5,Math.sin(n)*.5])}return e}case`cloud`:return[[0,0],[-.2,-.1],[.2,-.1],[0,.15]];default:return[[0,0]]}}function q(e,t,n,r,i,a,o,s,c,l,u,d,f=0){let p=u??r,m=d??i,h=Math.random()*Math.PI*2,g=0,_=null,v=Math.sqrt(t*t+n*n)*.5,y=e.gridScale;for(let u=0;u<B;u++){let u=p+g*Math.cos(h),d=m+g*Math.sin(h);if(u-t<0||u+t>=s||d-n<0||d+n>=c){h+=R,g+=z*R;continue}let b=T((u-r)/a,(d-i)/a,o);if(b>.15+f){g+=Math.abs(b)*a*.8+v,h+=R;continue}if(e.mipBlockOccupied(Math.floor(u/y),Math.floor(d/y))){g+=2*z*R,h+=R;continue}let[x,S]=[u,d];if(!M(x,S,t,n,r,i,a,o).fits){let[e,s]=N(x,S,t,n,r,i,a,o,4);if(!M(e,s,t,n,r,i,a,o).fits){h+=R,g+=z*R;continue}x=e,S=s}if(!e.checkCollision(x,S,t,n)){let r=e.densityAt(x,S,Math.max(t,n)*1.5);if((_===null||r<_.score)&&(_={x,y:S,score:r,rotated:!1},r<.08))break}if(l){let[l,u]=[n,t];if(x-l>=0&&x+l<s&&S-u>=0&&S+u<c&&M(x,S,l,u,r,i,a,o).fits&&!e.checkCollision(x,S,l,u)){let t=e.densityAt(x,S,Math.max(l,u)*1.5);if((_===null||t<_.score)&&(_={x,y:S,score:t,rotated:!0},t<.08))break}}h+=R,g+=z*R}return _}var ce=[-.45,-.55,-.35,-.25,-.18,-.12,-.08,-.05,-.03,-.02],le=[-.02,-.03,-.05,-.08,-.12,-.18,-.25,-.35,-.45,-.55];function ue(e,t,n,r,i,a,o,s,c,l,u,d=0){let f=e.gridScale,p=u<.25?ce:le,m=null,h=0;for(let u=0;u<p.length;u++){let d=p[u],g=I(t,n,a,o,d);for(let[p,_]of F(o,d,g)){let d=r+p*a,g=i+_*a;if(d-t<0||d+t>=s||g-n<0||g+n>=c||e.mipBlockOccupied(Math.floor(d/f),Math.floor(g/f))||o!==`circle`&&ne(p,_,t,n,o,a))continue;let[v,y]=[d,g];if(!M(v,y,t,n,r,i,a,o).fits){let[e,s]=N(v,y,t,n,r,i,a,o,3);if(!M(e,s,t,n,r,i,a,o).fits)continue;v=e,y=s}let b=(v-r)/a,x=(y-i)/a,S=T(b,x,o),C=Math.max(t,n)/a,w=S>-C&&S<=C*1.5;if(!e.checkCollision(v,y,t,n)){let r=e.densityAt(v,y,Math.max(t,n)*1.5);if((m===null||r<m.score)&&(m={x:v,y,score:r,rotated:!1},h=u,r<.03))return m}if(w&&l){let l=j(b,x,o);for(let d of[l,l+Math.PI/2]){let l=Math.abs(Math.cos(d))<.3,[f,p]=l?[n,t]:[t,n];if(v-f>=0&&v+f<s&&y-p>=0&&y+p<c&&M(v,y,f,p,r,i,a,o).fits&&!e.checkCollision(v,y,f,p)){let t=e.densityAt(v,y,Math.max(f,p)*1.5);if((m===null||t<m.score)&&(m={x:v,y,score:t,rotated:l},h=u,t<.03))return m}}}if(l){let[l,d]=[n,t];if(v-l>=0&&v+l<s&&y-d>=0&&y+d<c&&M(v,y,l,d,r,i,a,o).fits&&!e.checkCollision(v,y,l,d)){let t=e.densityAt(v,y,Math.max(l,d)*1.5);if((m===null||t<m.score)&&(m={x:v,y,score:t,rotated:!0},h=u,t<.03))return m}}}if(m&&m.score<.08&&h<=u)return m}if(m)return m;let g=K(o);for(let[u,f]of g){let p=q(e,t,n,r,i,a,o,s,c,l,r+u*a,i+f*a,d);if(p)return p}return null}function de(e,t,n,r,i,a,o,s,c,l,u,d=0){return o===`circle`?q(e,t,n,r,i,a,o,s,c,l,void 0,void 0,d):ue(e,t,n,r,i,a,o,s,c,l,u,d)}function fe(e,t,n,r,i,a,o,s,c,l,u){let d=a+t*s,f=o+n*s;return d-r<0||d+r>=l||f-i<0||f+i>=u||!M(d,f,r,i,a,o,s,c).fits||e.checkCollision(d,f,r,i)?null:{x:d,y:f,rotated:!1}}function pe(e,t){let n=t.estimateMaxFreeArea();return e<=n*.3?0:e<=n*.8?1:e<=n*1.5?2:3}function me(e,t={}){let n={...ae,...t};if(e.length===0)return{words:[],placedCount:0,totalCount:0,fillRate:0};let{width:r,height:i,shape:a,minFontSize:o,maxFontSize:s,padding:c,gridScale:l,rotationSteps:u,fontFamily:d,fontWeight:f}=n,p=[...e].sort((e,t)=>t.weight-e.weight),m=Math.max(...p.map(e=>e.weight),1),h=r/2,g=i/2,_=Math.min(r,i)/2*.85,v=document.createElement(`canvas`).getContext(`2d`),y=()=>v,x=s*se(p,m,oe(a,_),o,s,c,d,String(f),a,y()),S=new b(r,i,l),C=[],w=u>=1,T=[];a!==`circle`&&(T=G(a,_));for(let e=0;e<p.length;e++){let t=p[e],n=e/p.length,s=n>.85?.02:0,l=W(t.weight,m,o,x),u,v;y().font=`${f} ${l}px ${d}`,u=y().measureText(t.text).width+c*2,v=(U(t.text)?l:l*1.2)+c*2;let b=pe(u*v,S),E=null;if(a!==`circle`&&e<Math.ceil(p.length*.1)){let e=Math.max(u,v),t=null,n=-1;for(let r=0;r<T.length;r++){let i=T[r];i.used||e<=i.clearance*.9&&(!t||i.clearance<t.clearance)&&(t=i,n=r)}if(t){let e=u/2,s=v/2;for(let[c,d]of[[0,0],[.06,0],[-.06,0],[0,.06],[0,-.06]]){let f=fe(S,t.nx+c,t.ny+d,e,s,h,g,_,a,r,i);if(f){let t=P(f.x,f.y,h,g,_,a,x,o,l,e,s),r=u,i=v;if(t<l){let e=t/l;r=u*e,i=v*e}E={x:f.x,y:f.y,fs:t,rotated:f.rotated,actualW:r,actualH:i},T[n].used=!0;break}}E||(T[n].used=!0)}}if(!E)for(let e=b;e<4;e++){if(e>b){let n=V[e];l=Math.max(o,W(t.weight,m,o,x)*n),y().font=`${f} ${l}px ${d}`,u=y().measureText(t.text).width+c*2,v=(U(t.text)?l:l*1.2)+c*2}let p=u/2,C=v/2,T=de(S,p,C,h,g,_,a,r,i,w,n,s);if(T){let e=l,t=A((T.x-h)/_,(T.y-g)/_,a);t<1&&(e=Math.max(o,e*t));let n=P(T.x,T.y,h,g,_,a,x,o,e,p,C),r=u,i=v;if(n<l){let e=n/l;r=u*e,i=v*e}E={x:T.x,y:T.y,fs:n,rotated:T.rotated,actualW:r,actualH:i};break}}if(!E){let e=o;y().font=`${f} ${e}px ${d}`;let n=y().measureText(t.text).width+c*2,s=(U(t.text)?e:e*1.2)+c*2,l=K(a);for(let[t,o]of l){let c=q(S,n/2,s/2,h,g,_,a,r,i,w,h+t*_,g+o*_,.04);if(c){E={x:c.x,y:c.y,fs:e,rotated:c.rotated,actualW:n,actualH:s};break}}if(!E){let t=q(S,n/2,s/2,h,g,_,a,r,i,w,h,g,.06);t&&(E={x:t.x,y:t.y,fs:e,rotated:t.rotated,actualW:n,actualH:s})}}if(!E)continue;let D={id:t.id,text:t.text,x:E.x,y:E.y,fontSize:E.fs,width:E.actualW??u,height:E.actualH??v,rotated:E.rotated};C.push(D);let O=E.actualW??u,k=E.actualH??v;S.markOccupied(E.x,E.y,E.rotated?k/2:O/2,E.rotated?O/2:k/2)}let E=0;for(let e of C)E+=e.width*e.height;let D=r*i>0?E/(r*i):0;return{words:C,placedCount:C.length,totalCount:e.length,fillRate:D}}var he=8,ge=3e4;function _e(e,t={},n={}){let{timeout:r=ge}=n,i=ye();return new Promise((n,a)=>{let o=new Blob([i],{type:`application/javascript`}),s=URL.createObjectURL(o),c=new Worker(s,{type:`classic`}),l=setTimeout(()=>{c.terminate(),URL.revokeObjectURL(s),a(Error(`WordCloud worker timed out`))},r);c.onmessage=e=>{if(clearTimeout(l),c.terminate(),URL.revokeObjectURL(s),e.data.type===`SUCCESS`){let{buffer:t,texts:r,placedCount:i,totalCount:a,fillRate:o}=e.data;n({words:ve(t,r),placedCount:i,totalCount:a,fillRate:o})}else e.data.type===`ERROR`?a(Error(e.data.error)):a(Error(`Unknown worker response`))},c.onerror=e=>{clearTimeout(l),c.terminate(),URL.revokeObjectURL(s),a(Error(e.message))},c.postMessage({type:`compute`,words:e,config:t})})}function ve(e,t){let n=e.length/he,r=[];for(let i=0;i<n;i++){let n=i*he,a=e[n+7];r.push({id:e[n],x:e[n+1],y:e[n+2],fontSize:e[n+3],width:e[n+4],height:e[n+5],rotated:e[n+6]!==0,text:t[a]||``})}return r}function ye(){return`
/* ================================================================== */
...
`}function be(e,t={}){let n=performance.now(),r=me(e,t),i=performance.now()-n;return i>50&&console.debug(`[wordcloud] computeSync took ${i.toFixed(1)}ms for ${e.length} words`),r}function xe(e,t={}){return e.length>100?_e(e,t):be(e,t)}var J=a(),Se=`"Segoe UI", "PingFang SC", "Microsoft YaHei", sans-serif`,Ce=1e3,we=2400,Y=.25,Te=4,X=.15;function Z(e,t,n){let r=t/100,i=n/100,a=r*Math.min(i,1-i),o=t=>{let n=(t+e/30)%12;return i-a*Math.max(-1,Math.min(n-3,9-n,1))},s=Math.max(0,Math.min(255,Math.round(o(0)*255))),c=Math.max(0,Math.min(255,Math.round(o(8)*255))),l=Math.max(0,Math.min(255,Math.round(o(4)*255)));return`#${s.toString(16).padStart(2,`0`)}${c.toString(16).padStart(2,`0`)}${l.toString(16).padStart(2,`0`)}`}function Ee(e,t,n){let r=document.createElement(`canvas`).getContext(`2d`);if(!r)return{inputs:[],colors:new Map,totalArea:0};let i=[...e].sort((e,t)=>t.articleCount-e.articleCount),a=new Map,o=0;return{inputs:i.map((e,i)=>{let s=e.articleCount/t,c=11+31*Math.sqrt(s);r.font=`bold ${c}px ${Se}`;let l=r.measureText(e.name),u=i*137.508%360,d=n?68:42;a.set(e.id,[u,70,d]);let f=l.width+6,p=c+6;return o+=f*p,{id:e.id,text:e.name,weight:e.articleCount,width:l.width,height:c}}),colors:a,totalArea:o}}function De(e,t,n,r,i,a,o){let s=window.devicePixelRatio||1;e.width=t*s,e.height=n*s,e.style.width=t+`px`,e.style.height=n+`px`;let c=e.getContext(`2d`);if(c){c.scale(s,s),c.clearRect(0,0,t,n);for(let e=0;e<r.length;e++){let t=r[e],n=e===a,s=i.get(t.id);if(!s)continue;let[l,u,d]=s,f=n?Math.min(d+18,90):d;c.save(),c.font=`bold ${t.fontSize}px ${Se}`,c.textAlign=`center`,c.textBaseline=`middle`;let p=c.createLinearGradient(t.x-t.width/2,t.y-t.height/2,t.x-t.width/2,t.y+t.height/2);p.addColorStop(0,Z(l,u,Math.min(f+8,95))),p.addColorStop(.5,Z(l,u,f)),p.addColorStop(1,Z(l,u,Math.max(f-6,5))),c.fillStyle=p,c.shadowColor=o?`rgba(0,0,0,0.5)`:`rgba(0,0,0,0.18)`,c.shadowBlur=n?8:3,c.shadowOffsetX=1,c.shadowOffsetY=1,c.fillText(t.text,t.x,t.y),c.restore()}}}function Oe({tags:e,shape:t=`circle`,onShapeChange:a}){let s=(0,y.useRef)(null),c=(0,y.useRef)(null),l=o(),[u,d]=(0,y.useState)(1),[f,p]=(0,y.useState)(0),[m,h]=(0,y.useState)(0),[g,_]=(0,y.useState)(!1),v=(0,y.useRef)({x:0,y:0,px:0,py:0}),[b,x]=(0,y.useState)(null),[S,C]=(0,y.useState)({x:0,y:0}),[w,T]=(0,y.useState)(!1),[E,D]=(0,y.useState)(()=>window.matchMedia(`(prefers-color-scheme: dark)`).matches);(0,y.useEffect)(()=>{let e=window.matchMedia(`(prefers-color-scheme: dark)`),t=e=>D(e.matches);return e.addEventListener(`change`,t),()=>e.removeEventListener(`change`,t)},[]);let O=(0,y.useMemo)(()=>Math.max(...e.map(e=>e.articleCount),1),[e]),{inputs:k,colors:A,totalArea:j}=(0,y.useMemo)(()=>Ee(e,O,E),[e,O,E]),M=(0,y.useMemo)(()=>{let e=j/.6,t=Math.ceil(Math.sqrt(e)*1.15);return Math.max(Ce,Math.min(we,t))},[j]),N=M,P=M,[ee,te]=(0,y.useState)({w:800,h:500});(0,y.useEffect)(()=>{let e=s.current;if(!e)return;let t=()=>{let t=e.clientWidth;te({w:t,h:Math.min(t*.78,600)})};t();let n=new ResizeObserver(()=>t());return n.observe(e),()=>n.disconnect()},[]);let[F,I]=(0,y.useState)([]);(0,y.useEffect)(()=>{if(k.length===0||N===0){I([]);return}let e=!1,n=xe(k,{width:N,height:P,shape:t,minFontSize:11,maxFontSize:42,padding:3,gridScale:3});return n instanceof Promise?n.then(t=>{e||(I(t.words),L(t.words,N,P))}):(I(n.words),L(n.words,N,P)),()=>{e=!0}},[k,t,N,P]);let L=(0,y.useCallback)((e,t,n)=>{if(e.length===0)return;let r=s.current;if(!r)return;let i=1/0,a=1/0,o=-1/0,c=-1/0;for(let t of e)i=Math.min(i,t.x-t.width/2),a=Math.min(a,t.y-t.height/2),o=Math.max(o,t.x+t.width/2),c=Math.max(c,t.y+t.height/2);let l=o-i,u=c-a,f=(i+o)/2,m=(a+c)/2,g=r.clientWidth,_=Math.min(g*.78,600),v=(g-32)/l,y=(_-32)/u,b=Math.min(v,y,1.5);d(Math.max(.25,b)),p(g/(2*Math.max(.25,b))-f),h(_/(2*Math.max(.25,b))-m)},[]),ne=(0,y.useCallback)(()=>{if(F.length===0){d(1),p(0),h(0);return}let e=s.current;if(!e)return;let t=1/0,n=1/0,r=-1/0,i=-1/0;for(let e of F)t=Math.min(t,e.x-e.width/2),n=Math.min(n,e.y-e.height/2),r=Math.max(r,e.x+e.width/2),i=Math.max(i,e.y+e.height/2);let a=r-t,o=i-n,c=(t+r)/2,l=(n+i)/2,u=e.clientWidth,f=Math.min(u*.78,600),m=(u-32)/a,g=(f-32)/o,_=Math.min(m,g,1.5);d(Math.max(.25,_)),p(u/(2*Math.max(.25,_))-c),h(f/(2*Math.max(.25,_))-l)},[F]),ae=(0,y.useCallback)(()=>d(e=>Math.min(Te,e+X)),[]),R=(0,y.useCallback)(()=>d(e=>Math.max(Y,e-X)),[]),z=(0,y.useCallback)(e=>{e.preventDefault();let t=s.current.getBoundingClientRect(),n=e.clientX-t.left,r=e.clientY-t.top,i=-Math.sign(e.deltaY)*X,a=Math.max(Y,Math.min(Te,u+i)),o=a/u;p(e=>n-o*(n-e)),h(e=>r-o*(r-e)),d(a)},[u]),B=(0,y.useCallback)(e=>{e.button===0&&(_(!0),v.current={x:e.clientX,y:e.clientY,px:f,py:m})},[f,m]);(0,y.useEffect)(()=>{if(!g)return;let e=e=>{let t=(e.clientX-v.current.x)/u,n=(e.clientY-v.current.y)/u;p(v.current.px+t),h(v.current.py+n)},t=()=>_(!1);return window.addEventListener(`mousemove`,e),window.addEventListener(`mouseup`,t),()=>{window.removeEventListener(`mousemove`,e),window.removeEventListener(`mouseup`,t)}},[g,u]);let V=(0,y.useDeferredValue)(b),H=(0,y.useRef)(()=>{});(0,y.useEffect)(()=>{H.current=()=>{let e=c.current;e&&De(e,N,P,F,A,V,E)}},[F,A,V,E,N,P]),(0,y.useEffect)(()=>{let e=requestAnimationFrame(()=>H.current());return()=>cancelAnimationFrame(e)},[F,V,E]);let U=(0,y.useCallback)((e,t)=>{let n=c.current;if(!n)return null;let r=n.getBoundingClientRect(),i=(e-r.left)/u,a=(t-r.top)/u;for(let e=F.length-1;e>=0;e--){let t=F[e];if(i>=t.x-t.width/2&&i<=t.x+t.width/2&&a>=t.y-t.height/2&&a<=t.y+t.height/2)return e}return null},[F,u,f,m]),W=(0,y.useCallback)(e=>{let t=U(e.clientX,e.clientY);if(t!==b&&x(t),t!==null){let t=s.current.getBoundingClientRect();C({x:e.clientX-t.left,y:e.clientY-t.top}),T(!0)}else T(!1)},[U,b]),oe=(0,y.useCallback)(()=>{x(null),T(!1)},[]),se=(0,y.useCallback)(t=>{let n=Math.abs(t.clientX-v.current.x),r=Math.abs(t.clientY-v.current.y);if(n>3||r>3)return;let i=U(t.clientX,t.clientY);if(i!==null){let t=F[i],n=e.find(e=>e.id===t.id);n&&l(`/tags/${n.slug}`)}},[U,l,F,e]);if(e.length===0)return(0,J.jsxs)(`div`,{className:`flex flex-col items-center justify-center py-16 text-center`,children:[(0,J.jsx)(`span`,{className:`text-4xl text-muted-foreground/30 mb-4`,children:`🏷️`}),(0,J.jsx)(`p`,{className:`text-lg font-medium text-foreground`,children:`暂无标签`}),(0,J.jsx)(`p`,{className:`mt-2 text-sm text-muted-foreground`,children:`标签正在整理中`})]});let G=b===null?null:F[b],K=G?e.find(e=>e.id===G.id):null;return(0,J.jsxs)(`div`,{ref:s,className:`w-full`,children:[(0,J.jsxs)(`div`,{className:`flex items-center justify-between mb-4 flex-wrap gap-2`,children:[(0,J.jsx)(`div`,{className:`flex items-center gap-1.5`,children:ie.map(e=>(0,J.jsx)(`button`,{type:`button`,onClick:()=>a?.(e),title:re[e].label,className:[`inline-flex items-center justify-center w-9 h-9 rounded-lg text-lg transition-all duration-200 select-none`,e===t?`bg-primary text-primary-foreground shadow-sm scale-110`:`text-muted-foreground hover:text-foreground hover:bg-accent`].join(` `),children:re[e].icon},e))}),(0,J.jsxs)(`div`,{className:`flex items-center gap-1`,children:[(0,J.jsx)(`button`,{type:`button`,onClick:R,title:`缩小`,className:`inline-flex items-center justify-center w-8 h-8 rounded-lg text-muted-foreground hover:text-foreground hover:bg-accent transition-colors`,children:(0,J.jsx)(i,{className:`h-4 w-4`})}),(0,J.jsxs)(`span`,{className:`text-xs text-muted-foreground font-mono w-12 text-center select-none`,children:[Math.round(u*100),`%`]}),(0,J.jsx)(`button`,{type:`button`,onClick:ae,title:`放大`,className:`inline-flex items-center justify-center w-8 h-8 rounded-lg text-muted-foreground hover:text-foreground hover:bg-accent transition-colors`,children:(0,J.jsx)(r,{className:`h-4 w-4`})}),(0,J.jsx)(`button`,{type:`button`,onClick:ne,title:`重置视图`,className:`inline-flex items-center justify-center w-8 h-8 rounded-lg text-muted-foreground hover:text-foreground hover:bg-accent transition-colors ml-1`,children:(0,J.jsx)(n,{className:`h-3.5 w-3.5`})})]})]}),(0,J.jsxs)(`div`,{className:`relative overflow-hidden rounded-lg border border-border bg-background select-none`,style:{width:`100%`,height:ee.h||500},onWheel:z,children:[(0,J.jsx)(`div`,{className:`absolute top-0 left-0 origin-top-left`,style:{transform:`translate(${f*u}px, ${m*u}px) scale(${u})`,width:N,height:P},children:(0,J.jsx)(`canvas`,{ref:c,className:`block cursor-grab active:cursor-grabbing`,style:{touchAction:`none`,width:N,height:P},onMouseMove:W,onMouseLeave:oe,onMouseDown:B,onClick:se})}),w&&K&&(0,J.jsxs)(`div`,{className:`absolute pointer-events-none px-2.5 py-1.5 rounded-md text-xs font-medium shadow-md border border-border bg-popover text-popover-foreground whitespace-nowrap transition-opacity duration-150 z-10`,style:{left:S.x+14,top:S.y-10,transform:`translateY(-100%)`},children:[K.name,(0,J.jsxs)(`span`,{className:`ml-1.5 text-muted-foreground font-normal`,children:[`(`,K.articleCount,` 篇)`]})]})]}),F.length<e.length&&(0,J.jsxs)(`p`,{className:`mt-2 text-center text-xs text-muted-foreground`,children:[`已显示 `,F.length,`/`,e.length,` 个标签 （部分标签因形状空间不足未显示）`]})]})}function Q(e){let t=e.articleCount||0;if(e.children)for(let n of e.children)t+=Q(n);return t}function $(e){return[...e].sort((e,t)=>{let n=Q(e);return Q(t)-n}).map(e=>({...e,children:e.children?$(e.children):void 0}))}var ke=(0,y.memo)(function e({node:n,depth:r=0}){let[i,a]=(0,y.useState)(r<1),o=n.children&&n.children.length>0,l=(0,y.useMemo)(()=>Q(n),[n]);return(0,J.jsxs)(`div`,{children:[(0,J.jsxs)(`div`,{className:`group flex items-center gap-2`,style:{paddingLeft:r*20},children:[o?(0,J.jsx)(`button`,{onClick:()=>a(!i),className:`flex-shrink-0 h-6 w-6 flex items-center justify-center rounded text-muted-foreground hover:text-foreground hover:bg-accent transition-colors`,children:i?(0,J.jsx)(t,{className:`h-4 w-4`}):(0,J.jsx)(s,{className:`h-4 w-4`})}):(0,J.jsx)(`span`,{className:`flex-shrink-0 w-6`}),(0,J.jsxs)(c,{to:`/categories/${n.slug}`,className:`flex-1 flex items-center justify-between rounded-lg px-3 py-2.5 transition-all hover:bg-accent group-hover:text-primary`,children:[(0,J.jsxs)(`div`,{className:`flex items-center gap-2 min-w-0`,children:[(0,J.jsx)(f,{className:`h-4 w-4 text-primary flex-shrink-0`}),(0,J.jsx)(`span`,{className:`font-medium text-foreground truncate`,children:n.name}),n.description&&(0,J.jsxs)(`span`,{className:`text-xs text-muted-foreground truncate hidden sm:inline`,children:[`— `,n.description]})]}),(0,J.jsxs)(`span`,{className:`flex-shrink-0 ml-2 font-mono text-xs text-muted-foreground`,children:[l,` 篇`]})]})]}),o&&i&&(0,J.jsx)(`div`,{className:`mt-0.5`,children:n.children.map(t=>(0,J.jsx)(e,{node:t,depth:r+1},t.id))})]})});function Ae(){let[t,n]=(0,y.useState)(`categories`),[r,i]=(0,y.useState)(`circle`),{data:a,isLoading:o}=d(`/categories`,u,m),{data:s,isLoading:l}=d(`/tags`,u,m),{data:p,isLoading:h}=d(`/columns`,u,m),b=(Array.isArray(a)?a:a?.list)||[],x=(Array.isArray(s)?s:s?.list)||[],S=(Array.isArray(p)?p:p?.list)||[],C=(0,y.useMemo)(()=>$(b),[b]);return(0,J.jsxs)(`div`,{className:`space-y-8`,children:[(0,J.jsx)(g,{title:`发现`,description:`按分类、专栏或标签探索文章。`}),(0,J.jsxs)(`div`,{children:[(0,J.jsx)(`span`,{className:`font-mono text-xs font-semibold text-primary tracking-widest uppercase`,children:`探索内容`}),(0,J.jsx)(`h1`,{className:`mt-4 text-3xl font-bold tracking-tight text-foreground md:text-4xl`,children:`发现`}),(0,J.jsx)(`p`,{className:`mt-4 max-w-2xl text-muted-foreground leading-relaxed`,children:`按分类、专栏或标签探索文章，找到你感兴趣的内容。`})]}),(0,J.jsxs)(`div`,{className:`flex items-center gap-2 flex-wrap`,children:[(0,J.jsxs)(`button`,{onClick:()=>n(`categories`),className:`inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium transition-colors ${t===`categories`?`bg-primary text-primary-foreground`:`border border-border text-muted-foreground hover:bg-accent hover:text-foreground`}`,children:[(0,J.jsx)(f,{className:`h-4 w-4`}),` 分类`]}),(0,J.jsxs)(`button`,{onClick:()=>n(`columns`),className:`inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium transition-colors ${t===`columns`?`bg-primary text-primary-foreground`:`border border-border text-muted-foreground hover:bg-accent hover:text-foreground`}`,children:[(0,J.jsx)(e,{className:`h-4 w-4`}),` 专栏`]}),(0,J.jsxs)(`button`,{onClick:()=>n(`tags`),className:`inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium transition-colors ${t===`tags`?`bg-primary text-primary-foreground`:`border border-border text-muted-foreground hover:bg-accent hover:text-foreground`}`,children:[(0,J.jsx)(v,{className:`h-4 w-4`}),` 标签`]})]}),t===`categories`?o?(0,J.jsx)(`div`,{className:`space-y-3`,children:Array.from({length:6}).map((e,t)=>(0,J.jsx)(`div`,{className:`animate-pulse rounded-lg border border-border bg-card p-4`,children:(0,J.jsx)(`div`,{className:`h-5 w-32 rounded bg-muted`})},t))}):C.length===0?(0,J.jsxs)(`div`,{className:`flex flex-col items-center justify-center py-16 text-center`,children:[(0,J.jsx)(f,{className:`h-12 w-12 text-muted-foreground/30 mb-4`}),(0,J.jsx)(`p`,{className:`text-lg font-medium text-foreground`,children:`暂无分类`}),(0,J.jsx)(`p`,{className:`mt-2 text-sm text-muted-foreground`,children:`分类正在整理中`})]}):(0,J.jsx)(_,{className:`rounded-xl border border-border bg-card p-4 md:p-6`,children:C.map(e=>(0,J.jsx)(ke,{node:e},e.id))}):t===`columns`?h?(0,J.jsx)(`div`,{className:`grid grid-cols-1 sm:grid-cols-2 gap-4`,children:Array.from({length:4}).map((e,t)=>(0,J.jsx)(`div`,{className:`animate-pulse rounded-xl border border-border bg-card p-5`,children:(0,J.jsxs)(`div`,{className:`flex items-start gap-4`,children:[(0,J.jsx)(`div`,{className:`h-10 w-10 shrink-0 rounded-lg bg-muted`}),(0,J.jsxs)(`div`,{className:`min-w-0 flex-1 space-y-2`,children:[(0,J.jsx)(`div`,{className:`h-5 w-24 rounded bg-muted`}),(0,J.jsx)(`div`,{className:`h-4 w-full rounded bg-muted`})]})]})},t))}):S.length===0?(0,J.jsxs)(`div`,{className:`flex flex-col items-center justify-center py-16 text-center`,children:[(0,J.jsx)(e,{className:`h-12 w-12 text-muted-foreground/30 mb-4`}),(0,J.jsx)(`p`,{className:`text-lg font-medium text-foreground`,children:`暂无专栏`}),(0,J.jsx)(`p`,{className:`mt-2 text-sm text-muted-foreground`,children:`专栏正在整理中`})]}):(0,J.jsx)(`div`,{className:`grid grid-cols-1 sm:grid-cols-2 gap-4`,children:S.map(t=>(0,J.jsx)(c,{to:`/categories/${t.slug}`,className:`group rounded-xl border border-border bg-card p-5 transition-all hover:border-primary/30 hover:shadow-sm`,children:(0,J.jsxs)(`div`,{className:`flex items-start gap-4`,children:[(0,J.jsx)(`div`,{className:`flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-primary/10 text-primary`,children:(0,J.jsx)(e,{className:`h-5 w-5`})}),(0,J.jsxs)(`div`,{className:`min-w-0 flex-1`,children:[(0,J.jsx)(`h3`,{className:`font-semibold text-foreground group-hover:text-primary transition-colors`,children:t.name}),(0,J.jsx)(`p`,{className:`mt-1 text-sm text-muted-foreground leading-relaxed`,children:t.description})]})]})},t.id))}):l?(0,J.jsx)(`div`,{className:`flex flex-wrap gap-3`,children:Array.from({length:12}).map((e,t)=>(0,J.jsx)(`div`,{className:`animate-pulse rounded-lg bg-muted px-4 py-2`,children:(0,J.jsx)(`div`,{className:`h-4 w-16 rounded bg-muted-foreground/10`})},t))}):x.length===0?(0,J.jsxs)(`div`,{className:`flex flex-col items-center justify-center py-16 text-center`,children:[(0,J.jsx)(v,{className:`h-12 w-12 text-muted-foreground/30 mb-4`}),(0,J.jsx)(`p`,{className:`text-lg font-medium text-foreground`,children:`暂无标签`}),(0,J.jsx)(`p`,{className:`mt-2 text-sm text-muted-foreground`,children:`标签正在整理中`})]}):(0,J.jsx)(`div`,{className:`rounded-xl border border-border bg-card p-4 md:p-6`,children:(0,J.jsx)(Oe,{tags:x,shape:r,onShapeChange:i})})]})}export{Ae as default};