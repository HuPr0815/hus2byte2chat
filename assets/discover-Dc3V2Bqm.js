import{t as e}from"./book-open-BPVyRVap.js";import{t}from"./chevron-down-DmMLTUcy.js";import{t as n}from"./rotate-ccw-DYRZ7poG.js";import{n as r,t as i}from"./zoom-out-OqX-jHCf.js";import{D as a,F as o,I as s,K as c,L as l,P as u,R as d,U as f,c as p,l as m,s as h}from"./index-nBfMv5ZZ.js";import{t as g}from"./head-seo-DbYOdswV.js";import{t as _}from"./stagger-animation-DTw_nu2d.js";var v=o(`hash`,[[`line`,{x1:`4`,x2:`20`,y1:`9`,y2:`9`,key:`4lhtct`}],[`line`,{x1:`4`,x2:`20`,y1:`15`,y2:`15`,key:`vyu0kd`}],[`line`,{x1:`10`,x2:`8`,y1:`3`,y2:`21`,key:`1ggp8o`}],[`line`,{x1:`16`,x2:`14`,y1:`3`,y2:`21`,key:`weycgp`}]]),y=c(f(),1),b=class{gridScale;gridWidth;gridHeight;canvasWidth;canvasHeight;data;stride;sat;satStride;totalOccupied=0;mipScale;mipData=null;mipWidth=0;mipHeight=0;mipStride=0;constructor(e,t,n=3,r=4){this.gridScale=n,this.canvasWidth=e,this.canvasHeight=t,this.mipScale=r,this.gridWidth=Math.ceil(e/n),this.gridHeight=Math.ceil(t/n),this.stride=Math.ceil(this.gridWidth/32),this.data=new Uint32Array(this.stride*this.gridHeight),this.satStride=this.gridWidth+1,this.sat=new Uint32Array(this.satStride*(this.gridHeight+1)),this.gridWidth>=r&&this.gridHeight>=r&&(this.mipWidth=Math.ceil(this.gridWidth/r),this.mipHeight=Math.ceil(this.gridHeight/r),this.mipStride=Math.ceil(this.mipWidth/32),this.mipData=new Uint32Array(this.mipStride*this.mipHeight))}clear(){this.data.fill(0),this.sat.fill(0),this.totalOccupied=0,this.mipData?.fill(0)}toGrid(e,t){return[Math.floor(e/this.gridScale),Math.floor(t/this.gridScale)]}markOccupied(e,t,n,r){let[i,a]=this.toGrid(e-n,t-r),[o,s]=this.toGrid(e+n,t+r),c=Math.max(0,i),l=Math.max(0,a),u=Math.min(this.gridWidth-1,o),d=Math.min(this.gridHeight-1,s);new Uint32Array(this.stride);for(let e=l;e<=d;e++){let t=e*this.stride,n=Math.floor(c/32),r=Math.floor(u/32);if(n===r)this.data[t+n]|=(1<<u-c+1)-1<<(c&31);else{this.data[t+n]|=~((1<<(c&31))-1);for(let e=n+1;e<r;e++)this.data[t+e]=4294967295;this.data[t+r]|=(1<<(u&31)+1)-1}}if(this.rebuildSat(l,d),this.mipData){let e=Math.floor(c/this.mipScale),t=Math.floor(u/this.mipScale),n=Math.floor(l/this.mipScale),r=Math.floor(d/this.mipScale);for(let i=n;i<=r;i++){let n=i*this.mipStride;for(let r=e;r<=t;r++){let e=n+Math.floor(r/32);this.mipData[e]|=1<<(r&31)}}}this.totalOccupied+=(u-c+1)*(d-l+1)}rebuildSat(e,t){let n=Math.max(0,e-1);for(let e=n;e<=t;e++){let t=e*this.stride,n=(e+1)*this.satStride,r=e*this.satStride,i=0;for(let e=0;e<this.gridWidth;e++){let a=this.data[t+Math.floor(e/32)]>>(e&31)&1;i+=a,this.sat[n+e+1]=this.sat[r+e+1]+i}}}satQuery(e,t,n,r){let i=Math.max(0,e),a=Math.max(0,t),o=Math.min(this.gridWidth-1,n),s=Math.min(this.gridHeight-1,r);if(i>o||a>s)return 0;let c=this.sat[a*this.satStride+i],l=this.sat[a*this.satStride+(o+1)],u=this.sat[(s+1)*this.satStride+i];return this.sat[(s+1)*this.satStride+(o+1)]-l-u+c}densityAt(e,t,n){let[r,i]=this.toGrid(e,t),a=Math.ceil(n/this.gridScale),o=r-a,s=i-a,c=r+a,l=i+a,u=this.satQuery(o,s,c,l),d=(Math.min(this.gridWidth-1,c)-Math.max(0,o)+1)*(Math.min(this.gridHeight-1,l)-Math.max(0,s)+1);return d>0?u/d:0}checkCollision(e,t,n,r){let[i,a]=this.toGrid(e-n,t-r),[o,s]=this.toGrid(e+n,t+r);if(i<0||o>=this.gridWidth||a<0||s>=this.gridHeight)return!0;let c=Math.floor(i/32),l=Math.floor(o/32);for(let e=a;e<=s;e++){let t=e*this.stride;if(c===l){let e=(1<<o-i+1)-1<<(i&31);if(this.data[t+c]&e)return!0}else{let e=~((1<<(i&31))-1);if(this.data[t+c]&e)return!0;for(let e=c+1;e<l;e++)if(this.data[t+e])return!0;let n=(1<<(o&31)+1)-1;if(this.data[t+l]&n)return!0}}return!1}mipBlockOccupied(e,t){if(!this.mipData)return!1;let n=Math.floor(e/this.mipScale),r=Math.floor(t/this.mipScale);if(n<0||n>=this.mipWidth||r<0||r>=this.mipHeight)return!0;let i=r*this.mipStride+Math.floor(n/32);return(this.mipData[i]&1<<(n&31))!=0}get freeCells(){return this.gridWidth*this.gridHeight-this.totalOccupied}get totalCells(){return this.gridWidth*this.gridHeight}estimateMaxFreeArea(){if(!this.mipData)return this.freeCells*this.gridScale*this.gridScale;let e=0;for(let t=0;t<this.mipData.length;t++)e+=32-x(this.mipData[t]);return e*this.mipScale*this.mipScale*this.gridScale*this.gridScale}};function x(e){return e-=e>>>1&1431655765,e=(e&858993459)+(e>>>2&858993459),e=e+(e>>>4)&252645135,e*16843009>>>24}function S(e,t,n){switch(n){case`circle`:return Math.sqrt(e*e+t*t)-1;case`heart`:{let n=e*1.2,r=(t+.22)*1.1,i=n*n+r*r-1,a=i*i*i-n*n*r*r*r,o=i*i,s=6*n*o-2*n*r*r*r,c=6*r*o-3*n*n*r*r,l=Math.sqrt(s*s+c*c);return l<1e-8?Math.sqrt(n*n+r*r)-.9:a/(l*1.15)}case`star`:{let n=Math.sqrt(e*e+t*t);if(n<.001)return-1;let r=(Math.atan2(t,e)%(2*Math.PI/5)+2*Math.PI/5)%(2*Math.PI/5),i=Math.PI/5;return n-(r<i?.42+r/i*.58:1-.58*((r-i)/i))}case`diamond`:return Math.abs(e)+Math.abs(t)-1;case`cloud`:{let n=[[0,0,.48],[-.38,.12,.4],[.38,.12,.4],[-.22,-.28,.44],[.22,-.28,.44],[0,.32,.34]],r=1/0;for(let[i,a,o]of n){let n=Math.sqrt((e-i)**2+(t-a)**2)-o;n<r&&(r=n)}return r}case`hexagon`:{let n=Math.sqrt(e*e+t*t);if(n<.001)return-1;let r=(Math.atan2(t,e)%(Math.PI/3)+Math.PI/3)%(Math.PI/3);return n-Math.cos(Math.PI/6)/Math.cos(r-Math.PI/6)}}}function C(e,t,n){switch(n){case`circle`:return e*e+t*t<=1;case`heart`:{let n=e*1.2,r=(t+.22)*1.1,i=n*n+r*r-1;return i*i*i-n*n*r*r*r<=.04}case`star`:{let n=Math.sqrt(e*e+t*t);if(n<.001)return!0;let r=(Math.atan2(t,e)%(2*Math.PI/5)+2*Math.PI/5)%(2*Math.PI/5),i=Math.PI/5;return n<=(r<i?.42+r/i*.58:1-.58*((r-i)/i))}case`diamond`:return Math.abs(e)+Math.abs(t)<=1;case`cloud`:for(let[n,r,i]of[[0,0,.48],[-.38,.12,.4],[.38,.12,.4],[-.22,-.28,.44],[.22,-.28,.44],[0,.32,.34]])if((e-n)**2+(t-r)**2<=i*i)return!0;return!1;case`hexagon`:{let n=Math.sqrt(e*e+t*t);if(n<.001)return!0;let r=(Math.atan2(t,e)%(Math.PI/3)+Math.PI/3)%(Math.PI/3);return n<=Math.cos(Math.PI/6)/Math.cos(r-Math.PI/6)}}}function w(e,t,n){return S(e,t,n)}function T(e,t){let n=e*1.2,r=(t+.22)*1.1,i=n*n+r*r-1,a=i*i,o=6*n*a-2*n*r*r*r,s=6*r*a-3*n*n*r*r;if(Math.sqrt(o*o+s*s)<1e-8){let e=Math.sqrt(n*n+r*r)||1;return[-n/e,-r/e]}let c=o/1.2,l=s/1.1,u=Math.sqrt(c*c+l*l);return[c/u,l/u]}function E(e,t,n){if(n===`heart`)return T(e,t);let r=S(e,t,n),i=Math.max(.001,Math.abs(r)*.01),a=S(e+i,t,n)-r,o=S(e,t+i,n)-r,s=Math.sqrt(a*a+o*o);if(s<1e-8){let n=Math.sqrt(e*e+t*t)||1;return[-e/n,-t/n]}return[a/s,o/s]}function D(e,t,n,r,i,a,o,s){let c=(e-i)/o,l=(t-a)/o,u=n/o,d=r/o;if(s===`circle`){let e=S(c,l,s),t=Math.sqrt(u*u+d*d);if(e>t)return{fits:!1,zone:`outside`};if(e<-t)return{fits:!0,zone:`deep`};let i=n*2*(r*2)>800?[[c,l],[c,l-d],[c,l+d],[c-u,l],[c+u,l],[c-u,l-d],[c+u,l-d],[c-u,l+d],[c+u,l+d]]:[[c,l],[c-u,l-d],[c+u,l-d],[c-u,l+d],[c+u,l+d]];for(let[e,t]of i)if(!C(e,t,s))return{fits:!1,zone:`edge`};return{fits:!0,zone:`edge`}}let f=s===`heart`?4:3,p=[[c,l],[c-u,l-d],[c+u,l-d],[c-u,l+d],[c+u,l+d]],m=0;for(let[e,t]of p)C(e,t,s)&&m++;return m>=f?{fits:!0,zone:m>=5?`deep`:`edge`}:{fits:!1,zone:`edge`}}function O(e,t,n,r,i,a,o,s,c=5){let l=e,u=t;for(let e=0;e<c;e++){let e=(l-i)/o,t=(u-a)/o,c=S(e,t,s);if(c<=0){if(D(l,u,n,r,i,a,o,s).fits)return[l,u];let[c,d]=E(e,t,s);l-=c*n*.3,u-=d*r*.3;continue}let[d,f]=E(e,t,s),p=Math.abs(c)*o;l-=d*p,u-=f*p}return[l,u]}function k(e,t,n,r,i,a,o,s,c,l,u){let d=S((e-n)/i,(t-r)/i,a);if(d<-.3)return c;let f=Math.max(l,u)/i;if(d>f)return s;if(a===`heart`){let e=(d+f*.3)/(f*1.3);return Math.max(s,Math.min(c,o-Math.max(0,Math.min(1,e))*(o-s)*.5))}let p=(d+f)/(2*f);return Math.max(s,Math.min(c,o-Math.max(0,Math.min(1,p))*(o-s)))}function A(e,t){if(e===`circle`)return[[0,0]];if(e===`heart`)return j(t);let n=[];for(let t=0;t<60;t++)for(let r=0;r<60;r++){let i=t/59*2-1,a=r/59*2-1;if(!C(i,a,e))continue;let o=S(i,a,e);n.push({x:i,y:a,sdf:o})}n.sort((e,t)=>e.sdf-t.sdf);let r=[];for(let e of n){if(r.length>=t)break;let n=!1;for(let[t,i]of r)if((e.x-t)**2+(e.y-i)**2<.03){n=!0;break}n||r.push([e.x,e.y])}return r}function j(e){let t=[[-.28,.18],[.28,.18],[0,-.42],[0,.05]],n=[],r=Math.max(1,Math.ceil(e/t.length));for(let[i,a]of t){let t=0;for(let o=0;o<.35&&t<r&&n.length<e;o+=.05)for(let s=0;s<8&&t<r&&n.length<e;s++){let e=s/8*Math.PI*2+Math.random()*.3,r=i+o*Math.cos(e),c=a+o*Math.sin(e);if(!C(r,c,`heart`))continue;let l=!1;for(let[e,t]of n)if((r-e)**2+(c-t)**2<.02){l=!0;break}l||(n.push([r,c]),t++)}}if(n.length<e){let t=[];for(let e=0;e<50;e++)for(let n=0;n<50;n++){let r=e/49*2-1,i=n/49*2-1;C(r,i,`heart`)&&t.push({x:r,y:i,sdf:S(r,i,`heart`)})}t.sort((e,t)=>e.sdf-t.sdf);for(let r of t){if(n.length>=e)break;let t=!1;for(let[e,i]of n)if((r.x-e)**2+(r.y-i)**2<.02){t=!0;break}t||n.push([r.x,r.y])}}return n}function*M(e,t,n=.06,r=.02){if(e===`circle`){let e=1+t;if(e<=0)return;let r=Math.ceil(2*Math.PI/n),i=Array.from({length:r},(e,t)=>t);for(let e=i.length-1;e>0;e--){let t=Math.floor(Math.random()*(e+1));[i[e],i[t]]=[i[t],i[e]]}for(let t of i){let n=t/r*2*Math.PI;yield[e*Math.cos(n),e*Math.sin(n)]}return}let i=Math.ceil(2*Math.PI/n),a=n*.4,o=[];for(let n=0;n<i;n++){let s=n/i*2*Math.PI+(Math.random()-.5)*a,c=.35+Math.abs(t)*.6,l=c*Math.cos(s),u=c*Math.sin(s),d=!1;for(let n=0;n<20;n++){let n=S(l,u,e)-t;if(Math.abs(n)<5e-4){d=!0;break}let[r,i]=E(l,u,e),a=r*r+i*i;if(a<1e-10)break;let o=n/a;l-=r*o,u-=i*o;let s=Math.sqrt(l*l+u*u);s>1.5&&(l*=1.5/s,u*=1.5/s)}if(d&&e===`heart`){let[t,n]=E(l,u,e);if(t*t+n*n<r*r)continue}S(l,u,e)<.02&&o.push([l,u])}if(o.length<10&&n>.02){yield*M(e,t,n*.5,r);return}for(let e=o.length-1;e>0;e--){let t=Math.floor(Math.random()*(e+1));[o[e],o[t]]=[o[t],o[e]]}for(let e of o)yield e}function N(e,t,n,r,i){let a=Math.max(e,t)/n;return r===`heart`&&i!==void 0?i>-.06?a>.1?.06:.03:i>-.2?a>.1?.08:.04:a>.15?.12:.06:a>.15?.12:a>.08?.08:.05}function P(e,t,n,r){let i=S(e,t,n);return Math.abs(i)*r*.7}function ee(e,t,n,r,i,a){let o=P(e,t,i,a);return n>o||r>o}var te={circle:{icon:`●`,label:`圆形`},heart:{icon:`♥`,label:`心形`},star:{icon:`★`,label:`星形`},diamond:{icon:`◆`,label:`菱形`},cloud:{icon:`☁`,label:`云形`},hexagon:{icon:`⬡`,label:`六边形`}},ne=[`circle`,`heart`,`star`,`diamond`,`cloud`,`hexagon`],F={width:800,height:600,shape:`circle`,minFontSize:11,maxFontSize:42,padding:3,gridScale:3,rotationSteps:0,fontFamily:`sans-serif`,fontWeight:`bold`},I=.12,L=.4,R=2e4,z=[1,.75,.5625,.421875],B=/[\u4e00-\u9fff\u3040-\u309f\u30a0-\u30ff\uac00-\ud7af]/;function V(e){let t=0;for(let n of e)B.test(n)&&t++;return t>e.length*.5}function H(e,t,n,r){return t<=0?n:n+(r-n)*Math.sqrt(e/t)}function U(e,t,n,r,i,a,o,s,c,l){let u=Math.random()*Math.PI*2,d=0,f=null,p=Math.sqrt(t*t+n*n)*.5,m=e.gridScale;for(let h=0;h<R;h++){let h=r+d*Math.cos(u),g=i+d*Math.sin(u);if(h-t<0||h+t>=s||g-n<0||g+n>=c){u+=I,d+=L*I;continue}let _=w((h-r)/a,(g-i)/a,o);if(_>.15){d+=Math.abs(_)*a*.8+p,u+=I;continue}if(e.mipBlockOccupied(Math.floor(h/m),Math.floor(g/m))){d+=2*L*I,u+=I;continue}let[v,y]=[h,g];if(!D(v,y,t,n,r,i,a,o).fits){let[e,s]=O(v,y,t,n,r,i,a,o,4);if(!D(e,s,t,n,r,i,a,o).fits){u+=I,d+=L*I;continue}v=e,y=s}if(!e.checkCollision(v,y,t,n)){let r=e.densityAt(v,y,Math.max(t,n)*1.5);if((f===null||r<f.score)&&(f={x:v,y,score:r,rotated:!1},r<.08))break}if(l){let[l,u]=[n,t];if(v-l>=0&&v+l<s&&y-u>=0&&y+u<c&&D(v,y,l,u,r,i,a,o).fits&&!e.checkCollision(v,y,l,u)){let t=e.densityAt(v,y,Math.max(l,u)*1.5);if((f===null||t<f.score)&&(f={x:v,y,score:t,rotated:!0},t<.08))break}}u+=I,d+=L*I}return f}var W=[-.4,-.5,-.62,-.32,-.26,-.2,-.16,-.12,-.09,-.06,-.04,-.02],G=[-.02,-.04,-.06,-.09,-.12,-.16,-.2,-.26,-.32,-.4,-.5,-.62];function K(e,t,n,r,i,a,o,s,c,l,u){let d=e.gridScale,f=u<.25?W:G,p=null,m=0;for(let u=0;u<f.length;u++){let h=f[u],g=N(t,n,a,o,h);for(let[f,_]of M(o,h,g)){let h=r+f*a,g=i+_*a;if(h-t<0||h+t>=s||g-n<0||g+n>=c||e.mipBlockOccupied(Math.floor(h/d),Math.floor(g/d))||o===`heart`&&ee(f,_,t,n,o,a))continue;let[v,y]=[h,g];if(!D(v,y,t,n,r,i,a,o).fits){let[e,s]=O(v,y,t,n,r,i,a,o,3);if(!D(e,s,t,n,r,i,a,o).fits)continue;v=e,y=s}if(!e.checkCollision(v,y,t,n)){let r=e.densityAt(v,y,Math.max(t,n)*1.5);if((p===null||r<p.score)&&(p={x:v,y,score:r,rotated:!1},m=u,r<.03))return p}if(l){let[l,d]=[n,t];if(v-l>=0&&v+l<s&&y-d>=0&&y+d<c&&D(v,y,l,d,r,i,a,o).fits&&!e.checkCollision(v,y,l,d)){let t=e.densityAt(v,y,Math.max(l,d)*1.5);if((p===null||t<p.score)&&(p={x:v,y,score:t,rotated:!0},m=u,t<.03))return p}}}if(p&&p.score<.08&&m<=u)return p}return p||(u>.7?U(e,t,n,r,i,a,o,s,c,l):null)}function re(e,t,n,r,i,a,o,s,c,l,u,d){let f=a+t*s,p=o+n*s;return f-r<0||f+r>=l||p-i<0||p+i>=u||!D(f,p,r,i,a,o,s,c).fits||e.checkCollision(f,p,r,i)?null:{x:f,y:p,rotated:!1}}function ie(e,t,n,r,i,a,o,s,c,l,u){return o===`circle`?U(e,t,n,r,i,a,o,s,c,l):K(e,t,n,r,i,a,o,s,c,l,u)}function q(e,t){let n=t.estimateMaxFreeArea();return e<=n*.3?0:e<=n*.8?1:e<=n*1.5?2:3}function J(e,t={}){let n={...F,...t};if(e.length===0)return{words:[],placedCount:0,totalCount:0,fillRate:0};let{width:r,height:i,shape:a,minFontSize:o,maxFontSize:s,padding:c,gridScale:l,rotationSteps:u,fontFamily:d,fontWeight:f}=n,p=[...e].sort((e,t)=>t.weight-e.weight),m=Math.max(...p.map(e=>e.weight),1),h=r/2,g=i/2,_=Math.min(r,i)/2*.85,v=new b(r,i,l),y=null,x=()=>(y||=document.createElement(`canvas`).getContext(`2d`),y),S=[],C=u>=1,w=[],T=0;a!==`circle`&&(w=A(a,Math.max(2,Math.min(8,Math.ceil(p.length*.08)))));for(let e=0;e<p.length;e++){let t=p[e],n=H(t.weight,m,o,s),l,u;if(t.width!==void 0&&t.height!==void 0)l=t.width+c*2,u=t.height+c*2;else{let e=x();if(!e)break;e.font=`${f} ${n}px ${d}`,l=e.measureText(t.text).width+c*2,u=(V(t.text)?n:n*1.2)+c*2}let y=q(l*u,v),b=null;if(a!==`circle`&&T<w.length&&e<Math.ceil(p.length*.15)){for(let e=y;e<4;e++){if(e>y){let r=z[e];n=Math.max(o,H(t.weight,m,o,s)*r);let i=x();if(!i)break;i.font=`${f} ${n}px ${d}`,l=i.measureText(t.text).width+c*2,u=(V(t.text)?n:n*1.2)+c*2}let p=l/2,S=u/2,[E,D]=w[T],O=[[0,0],[.08,0],[-.08,0],[0,.08],[0,-.08]],A=!1;for(let[e,t]of O){let c=re(v,E+e,D+t,p,S,h,g,_,a,r,i,C);if(c){let e=k(c.x,c.y,h,g,_,a,s,o,n,p,S);b={x:c.x,y:c.y,fs:e,rotated:c.rotated},A=!0;break}}if(A)break}T++}if(!b)for(let S=y;S<4;S++){if(S>y){let e=z[S];n=Math.max(o,H(t.weight,m,o,s)*e);let r=x();if(!r)break;r.font=`${f} ${n}px ${d}`,l=r.measureText(t.text).width+c*2,u=(V(t.text)?n:n*1.2)+c*2}let w=l/2,T=u/2,E=ie(v,w,T,h,g,_,a,r,i,C,e/p.length);if(E){let e=k(E.x,E.y,h,g,_,a,s,o,n,w,T);b={x:E.x,y:E.y,fs:e,rotated:E.rotated};break}}if(!b)continue;let E={id:t.id,text:t.text,x:b.x,y:b.y,fontSize:b.fs,width:l,height:u,rotated:b.rotated};S.push(E),v.markOccupied(b.x,b.y,b.rotated?u/2:l/2,b.rotated?l/2:u/2)}let E=0;for(let e of S)E+=e.width*e.height;let D=r*i>0?E/(r*i):0;return{words:S,placedCount:S.length,totalCount:e.length,fillRate:D}}var Y=8,ae=3e4;function oe(e,t={},n={}){let{timeout:r=ae}=n,i=ce();return new Promise((n,a)=>{let o=new Blob([i],{type:`application/javascript`}),s=URL.createObjectURL(o),c=new Worker(s,{type:`classic`}),l=setTimeout(()=>{c.terminate(),URL.revokeObjectURL(s),a(Error(`WordCloud worker timed out`))},r);c.onmessage=e=>{if(clearTimeout(l),c.terminate(),URL.revokeObjectURL(s),e.data.type===`SUCCESS`){let{buffer:t,texts:r,placedCount:i,totalCount:a,fillRate:o}=e.data;n({words:se(t,r),placedCount:i,totalCount:a,fillRate:o})}else e.data.type===`ERROR`?a(Error(e.data.error)):a(Error(`Unknown worker response`))},c.onerror=e=>{clearTimeout(l),c.terminate(),URL.revokeObjectURL(s),a(Error(e.message))},c.postMessage({type:`compute`,words:e,config:t})})}function se(e,t){let n=e.length/Y,r=[];for(let i=0;i<n;i++){let n=i*Y,a=e[n+7];r.push({id:e[n],x:e[n+1],y:e[n+2],fontSize:e[n+3],width:e[n+4],height:e[n+5],rotated:e[n+6]!==0,text:t[a]||``})}return r}function ce(){return`
/* ================================================================== */
...
function heartAnalyticGradient(nx, ny) {
  var hx = nx * 1.2, hy = (ny + 0.22) * 1.1, v = hx * hx + hy * hy - 1, v2 = v * v
  var dfx = 6 * hx * v2 - 2 * hx * hy * hy * hy, dfy = 6 * hy * v2 - 3 * hx * hx * hy * hy
...
function computeHeartLobeAnchors(count) {
  var lobeCenters = [[-0.28, 0.18], [0.28, 0.18], [0, -0.42], [0, 0.05]]
